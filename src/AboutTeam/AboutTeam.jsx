    ...
    return(
        <div className="AboutTeam">
            ...
            <div className="AboutTeam_info">
                ...
                <div className="AboutTeam_info_avatrs">
                    <img src="src/assets/AboutTeam/avtr1.jpeg" alt="" />
                    <img src="src/assets/AboutTeam/avtr2.jpeg" alt="" />
                    <img src="src/assets/AboutTeam/avtr3.jpeg" alt="" />
                </div>
            </div>
        </div>
    )
